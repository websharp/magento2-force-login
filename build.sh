...
[[ "${__helptext+x}" ]] || read -r -d '' __helptext <<-'EOF' || true # exits non-zero when EOF encountered
 Build CLI for bitExpert Force Login Module for Magento 2.
EOF
...
cp -pPR "${SRC}/Controller" "${TMP}/Controller"
cp -pPR "${SRC}/docs" "${TMP}/docs"
cp -pPR "${SRC}/etc" "${TMP}/etc"
cp -pPR "${SRC}/Helper" "${TMP}/Helper"
cp -pPR "${SRC}/Model" "${TMP}/Model"
cp -pPR "${SRC}/Plugin" "${TMP}/Plugin"
cp -pPR "${SRC}/Repository" "${TMP}/Repository"
cp -pPR "${SRC}/resources" "${TMP}/resources"
cp -pPR "${SRC}/Setup" "${TMP}/Setup"
cp -pPR "${SRC}/Test" "${TMP}/Test"
cp -pPR "${SRC}/Ui" "${TMP}/Ui"
cp -pPR "${SRC}/Validator" "${TMP}/Validator"
cp -pPR "${SRC}/view" "${TMP}/view"
